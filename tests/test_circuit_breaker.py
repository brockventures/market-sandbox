...
def test_circuit_breaker_bands_and_vwap():
    ref = AgoraReferee()
...
def test_in_band_execution_updates_vwap():
    ref = AgoraReferee()
...
def test_out_of_band_breach_triggers_2_round_halt():
    ref = AgoraReferee()
...
def test_halted_book_accepts_auction_orders_and_reopens():
    ref = AgoraReferee()
