...
class AgoraReferee:
    ...
    def reset_to_genesis(self, asymmetric: bool = False, spawn_map: Optional[Dict[str, str]] = None) -> Dict[str, Any]:
        """
    ...
    def new_game(self, seed: Optional[int] = None, warmup_rounds: Optional[int] = None, asymmetric: bool = False, spawn_map: Optional[Dict[str, str]] = None) -> Dict[str, Any]:
        """
